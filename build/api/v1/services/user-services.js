...
exports.userFailed = exports.userApproved = exports.getUsers = exports.deleteUser = void 0;
...
var userApproved = function userApproved(req, res) {
  _bcryptjs["default"].hash(req.body.password, 10, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, hashedPassword) {
      var newUser;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _userModel["default"].find({}, 'username').sort({
            username: 1
          });
        case 3:
