...
exports.postsInStorage = exports.postRequested = exports.postFailed = exports.postEdit = exports.postDelete = exports.postApproved = void 0;
var _postModel = _interopRequireDefault(require("../models/post-model"));
var _commentModel = _interopRequireDefault(require("../models/comment-model"));
var _likesModel = _interopRequireDefault(require("../models/likes-model"));
...
var postApproved = /*#__PURE__*/function () {
  ...
  return function postApproved(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.postApproved = postApproved;
var postsInStorage = /*#__PURE__*/function () {
  ...
  return function postsInStorage(_x3) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return Promise.all([_postModel["default"].findByIdAndDelete(req.params.id), _commentModel["default"].findByIdAndDelete({
            on: req.params.id
          }), _likesModel["default"].findByIdAndDelete({
            on: req.params.id
          })]);
        case 3:
...
var postRequested = /*#__PURE__*/function () {
  ...
  return function postRequested(_x6, _x7) {
    return _ref4.apply(this, arguments);
  };
}();
exports.postRequested = postRequested;
var postEdit = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 4;
          return _postModel["default"].findByIdAndUpdate(req.params.id, post, {
            "new": true
          });
        case 4:
  ...
  return function postEdit(_x8, _x9) {
